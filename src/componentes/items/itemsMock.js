const productos = [
    ...
    { id: Math.random(), img: 'https://imgs.search.brave.com/vECmvKRo22IsFCp4gThSucIaFTINV3DpQueqUl1FoX0/rs:fit:474:225:1/g:ce/aHR0cHM6Ly90c2Uz/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5h/eWg1UzhQM0dYRzkz/LVU0U1lmajRBSGFI/YSZwaWQ9QXBp', nombre: 'Procesador Intel Core i9-11900K', categoria: 'ComponentesdePC', precio: 599.99, stock: Math.floor(Math.random() * 15) + 1, descripcion: '8 núcleos, 16 hilos, frecuencia base de 3.5 GHz' },
    ...
    { id: Math.random(), img: 'https://imgs.search.brave.com/x7EPwARKQnkCBnU2lVbHkdGwCjBD-eGYwF0jdv15hQc/rs:fit:474:225:1/g:ce/aHR0cHM6Ly90c2Uy/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5H/aUozdWM4SHZzMGZ4/cVVncURsS1dBSGFI/YSZwaWQ9QXBp', nombre: 'Disco duro sólido Samsung 970 EVO Plus', categoria: 'AlmacenamientodePC', precio: 149.99, stock: Math.floor(Math.random() * 15) + 1, descripcion: '500 GB NVMe M.2, velocidad de lectura de 3500 MB/s' },
